...
export const GET_SELECTED_BLOG_REQUEST = "BLOG.GET_SELECTED_BLOG_REQUEST";
export const GET_SELECTED_BLOG_SUCCESS = "BLOG.GET_SELECTED_BLOG_SUCCESS";
export const GET_SELECTED_BLOG_FAILURE = "BLOG.GET_SELECTED_BLOG_FAILURE";
